...
const CACHE = "medaillier-v11";
const FICHIERS = ["./", "./index.html", "./manifest.webmanifest", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png", "./series-donnees.json", "./data/manifest.json", "./LICENSE", "./README.md"];
